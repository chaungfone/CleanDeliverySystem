-- ============================================================================
-- Water Delivery Management System - Supabase (PostgreSQL) Database Schema
-- Based on PRD v2.1 - Section 9 (Database Design) & Section 11 (Security)
-- Single file: run once in Supabase Dashboard > SQL Editor
-- ============================================================================
...
-- ============================================================================
-- 4.5 GRANTS (required when running schema via SQL Editor)
--     Tables created through the SQL Editor are NOT auto-granted.
--     RLS policies still enforce row-level security for anon/authenticated.
-- ============================================================================
