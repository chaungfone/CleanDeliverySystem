      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-neutral-90 shadow-sm">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex items-center justify-between border border-neutral-90 rounded-lg p-3">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-accent text-primary font-medium hover:opacity-90"
              >
        ...
        <div className="bg-white p-6 rounded-xl border border-neutral-90 shadow-sm">
          ...
          <div className="space-y-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-between border border-neutral-90 rounded-lg p-3 hover:bg-neutral-99 transition-colors"
            >
        ...
        {/* Account Actions */}
        <div className="bg-white p-6 rounded-xl border border-neutral-90 shadow-sm">
          <h3 className="font-bold mb-5">{t('settings.accountActions')}</h3>
          <div className="space-y-3">
            <button
              onClick={handleRefresh}
              className="w-full flex items-center gap-3 px-4 py-3 border border-neutral-90 rounded-lg text-sm font-medium text-neutral-700 hover:bg-neutral-99"
            >
            ...
            <button
              onClick={logout}
              className="w-full flex items-center gap-3 px-4 py-3 border border-red-100 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50"
            >
