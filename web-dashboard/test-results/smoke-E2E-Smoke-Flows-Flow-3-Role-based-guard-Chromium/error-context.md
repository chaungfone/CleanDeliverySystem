...
- Name: smoke.spec.ts >> E2E Smoke Flows >> Flow 3: Role-based guard
...
```yaml
- generic [ref=f1e3]:
  - button "မြန်မာ" [ref=f1e5] [cursor=pointer]
  - generic [ref=f1e11]:
    - generic [ref=f1e17]:
      - heading "Clean Delivery" [level=1] [ref=f1e18]
      - paragraph [ref=f1e19]: Admin Dashboard
    - generic [ref=f1e20]:
      - generic [ref=f1e21]: Phone Number
      - textbox "09xxxxxxxxx" [ref=f1e25]
      - button "Request OTP" [ref=f1e26] [cursor=pointer]
```
