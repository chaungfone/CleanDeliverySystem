...
- Name: smoke.spec.ts >> E2E Smoke Flows >> Flow 2: Create order and mark delivered
- Location: e2e\smoke.spec.ts:34:3
...
Call log:
  - waiting for locator('button:has-text("Create Order")')
